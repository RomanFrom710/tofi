    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        RequestAction_Id = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Actions", t => t.RequestAction_Id)
        ...
        {
            DropForeignKey("dbo.Actions", "Employee_Id", "dbo.Employees");
            ...
            DropForeignKey("dbo.CreditRequests", "RequestAction_Id", "dbo.Actions");
            ...
            DropForeignKey("dbo.CreditPayments", "PaymentAction_Id", "dbo.Actions");
            ...
            DropIndex("dbo.CreditRequests", new[] { "RequestAction_Id" });
            ...
            DropIndex("dbo.CreditPayments", new[] { "PaymentAction_Id" });
            DropIndex("dbo.Employees", new[] { "User_Id" });
            DropIndex("dbo.Actions", new[] { "Employee_Id" });
